/*
  TestPairing.h - testul 8: inrolarea si receptia datelor.
  ---------------------------------------------------------------------
  ...
  lucruri, in acelasi tick():
    ...
    2. DATE. Un DATA_UP este acceptat oricand, daca vine de la o adresa
       ...
       circula in clar, este dat lui SensorPacketCodec::decode(), adica
       exact aceluiasi cod care serveste testul 7.
       ...
       fara MIC, orice emitator poate pretinde orice numar. Al doilea:
  ...
  DIFERENTA FATA DE TESTUL 7: acolo se asculta un pachet de temperatura
  fara nicio adresa, deci fara sa se stie de la cine vine. Aici fiecare
  pachet poarta numarul senzorului si un frame counter, deci se stie cui
  se atribuie si se respinge daca este rejucat. Ce NU mai face niciunul
  dintre ele, de cand a fost scoasa criptografia, este sa verifice ca
  emitatorul chiar este cine pretinde.
